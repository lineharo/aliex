    ...
    public function makeTitle($prompt)
    {
        ...
        try {
            ...
            ->post($url, [
                'system_instruction' => [
                    'parts' => [
                        'text' => 'Ты профессиональный SEO-специалист и пишешь тексты для сайтов с учётом ключевых слов и всех правил. Тебе нужно написать название для товара на сайте.'
                    ],
                ],
                'contents' => [
                    [

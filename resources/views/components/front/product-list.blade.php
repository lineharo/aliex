    ...
    @foreach ($products as $product)
        ...
        <div class="product-list__item">
            ...
            <div class="product-list__info">
                ...
                <div class="product-list__store-name">
                        {{ $product->store_name }}
                </div>

                <div class="product-list__name">
                    <a href="{{ route('front.product.show', ['slug' => $product->slug]) }}" target="_blank">
                        @if(mb_strlen($product->name) > 70)
                            {{ mb_substr($product->name, 0, 67) }}...
                        @else
                            {{ $product->name }}
                        @endif
                    </a>
                ...
                <div class="product-list__popularity">
                ...
                <div class="product-list__price">
                    <div class="product-list__price-final">
                    ...
                    <div class="product-list__price-full">
                    ...
                    <div class="product-list__price-discount">
                ...
                <div class="product-list__button">
                    <a href="{{ route('front.away.site', ['product' => $product->ali_id]) }}" class="button">КУПИТЬ</a>
                </div>

...
<div class="page-header__inner">
    ...
    <nav class="page-header__nav">
        <a href="{{ route('front.promocodes.index') }}" class="page-header__nav-item">Промокоды</a>
        <a href="{{ route('front.article.index') }}" class="page-header__nav-item">Статьи</a>
    </nav>
    ...
    <div class="page-header__socials">
        ...
        <a href="https://vk.com/ali_ex_ru" class="soc-button" target="_blank" rel="nofollow">
            ...
            <div class="soc-button__icon">
                <svg viewBox="0 0 35 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.063 22C7.10489 22 0.284215 13.7417 0 0H5.99002C6.18677 10.0861 10.6027 14.3583 14.1004 15.2392V0H19.7409V8.69863C23.1949 8.32427 26.8235 4.36036 28.0477 0H33.6881C32.7481 5.37339 28.813 9.3373 26.0148 10.9669C28.813 12.2882 33.2948 15.7457 35 22H28.7912C27.4576 17.8158 24.135 14.5786 19.7409 14.1381V22H19.063Z" fill="#6C6C6C"/></svg>
            </div>
        </a>
    </div>
